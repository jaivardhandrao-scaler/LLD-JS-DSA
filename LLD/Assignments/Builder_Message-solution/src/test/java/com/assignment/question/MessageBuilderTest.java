...
public class MessageBuilderTest {
    ...
    private static final Class<?> originalClass = Message.class;
    ...
    public static void setUp() {
        ...
        String packageName = MessageBuilderTest.class.getPackageName();
    ...
    private void testBuildMethodCopiesValuesToOuterClass() {
        ...
        try {
            ...
            Field senderField = builderClass.getDeclaredField("sender");
            Field contentField = builderClass.getDeclaredField("content");
            Field deliveredField = builderClass.getDeclaredField("isDelivered");

            senderField.setAccessible(true);
            contentField.setAccessible(true);
            deliveredField.setAccessible(true);

            senderField.set(builderInstance, "Tantia Tope");
            contentField.set(builderInstance, "1857");
            deliveredField.set(builderInstance, false);
    ...
    private void testBuildMethodWithReferenceForSpecificFields() {
        try {
            ...
            // Set values for sender, content, and isDelivered in the reference instance
            ...
            Field senderField = referenceClass.getDeclaredField("sender");
            Field contentField = referenceClass.getDeclaredField("content");
            Field isDeliveredField = referenceClass.getDeclaredField("isDelivered");

            senderField.setAccessible(true);
            contentField.setAccessible(true);
            isDeliveredField.setAccessible(true);

            senderField.set(referenceInstance, "Tantia Tope");
            contentField.set(referenceInstance, "1857");
            isDeliveredField.set(referenceInstance, false);
